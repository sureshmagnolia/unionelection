...
async def run_extraction_py(event=None):
    ...
    try: # <-- CORRECTED SYNTAX
        ...
        js.disable_room_allotment_tab(True) # Disable room allotment
        js.disable_search_tab(True) # <-- ADDED: Disable search
        js.disable_scribe_settings_tab(True) # Disable scribe settings
        ...
        js.disable_search_tab(False) # <-- ADDED
        js.disable_scribe_settings_tab(False) # Enable scribe settings
        ...
        js.populate_search_session_dropdown() # <-- ADDED
