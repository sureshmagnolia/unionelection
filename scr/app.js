...
const viewRoomSettings = document.getElementById('view-room-settings');
...
const navRoomSettings = document.getElementById('nav-room-settings');
// *** NEW SCRIBE NAV ***
...
// **********************
const allNavButtons = [navExtractor, navSettings, navRoomSettings, navQPCodes, 
    navScribeSettings, navScribeAllotment, // <-- NEW
    navRoomAllotment, navReports, navAbsentees];
const allViews = [viewExtractor, viewSettings, viewRoomSettings, viewQPCodes, 
    viewScribeSettings, viewScribeAllotment, // <-- NEW
    viewRoomAllotment, viewReports, viewAbsentees];
